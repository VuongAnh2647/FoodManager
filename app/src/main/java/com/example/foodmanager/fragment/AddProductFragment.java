...
import com.example.foodmanager.Adapter.SpinnerTypeProductAdapter;
import com.example.foodmanager.R;
import com.example.foodmanager.base.BaseFragment;
import com.example.foodmanager.databinding.FragmentAddProductBinding;
...
public class AddProductFragment extends BaseFragment {
    ...
    private void saveProduct(Context context){
            ...
            Product product = new Product(key,binding.edNameProduct.getText().toString().trim(),binding.edDescribe.getText().toString().trim(),typeProduct, Double.parseDouble(binding.edPrice.getText().toString().trim()), binding.edNote.getText().toString().trim(),true);
